...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { name: @organisation.name, users_id: @organisation.users_id } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { name: @organisation.name, users_id: @organisation.users_id } }
